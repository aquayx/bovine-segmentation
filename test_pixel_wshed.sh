...
OUTPUT_WSHED_BX="./results/pixel/wshed/b/x/"
OUTPUT_WSHED_BY="./results/pixel/wshed/b/y/"
OUTPUT_WSHED_WX="./results/pixel/wshed/w/x/"
OUTPUT_WSHED_WY="./results/pixel/wshed/w/y/"
...
python3 mass_metrics.py -g $GT_BX -p $PRED_WSHED_X -o $OUTPUT_WSHED_BX -m pixel
echo "Network: Watershed | Grey as: Negative | Test: y"
python3 mass_metrics.py -g $GT_BX -p $PRED_WSHED_Y -o $OUTPUT_WSHED_BY -m pixel
echo "Network: Watershed | Grey as: Positive | Test: x"
python3 mass_metrics.py -g $GT_WX -p $PRED_WSHED_X -o $OUTPUT_WSHED_WX -m pixel
echo "Network: Watershed | Grey as: Positive | Test: y"
python3 mass_metrics.py -g $GT_WY -p $PRED_WSHED_Y -o $OUTPUT_WSHED_WY -m pixel
